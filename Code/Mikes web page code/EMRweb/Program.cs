...
// Initial data endpoint for the client. In production replace with real auth and patient lookup.
app.MapGet("/api/initialdata", () => Results.Json(new {
    patient = new { id = "p123", name = "Jane Doe", mrn = "MRN001", encounter = "ENC-78" },
    care = new[] { "Dr. Smith (Psychiatrist)", "Nurse Lee", "Social Worker" },
    currentUser = new { id = "prov1", name = "You", role = "clinician", token = "" }
}));
